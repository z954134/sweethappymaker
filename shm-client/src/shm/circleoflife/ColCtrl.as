package shm.circleoflife
{
	...
	public class ColCtrl implements IMXMLObject
	{
		...
		private const LABEL:String="chxl=0:|elem1|elem2|elem3|elem4|elem5|elem6";
		private const MARKER:String="chm=B,FF000080,0,1.0,5.0|h,0000FF,0,0.5,0.5|h,0000FF,0,1.0,1.0";
		private const URL_TEMPLATE:String=BASE_URL + "?" + STYLE + "&" + LABEL + "&" + MARKER;
		...
		{
			var str:String="chd=t:" + view.elem1.value + "," + view.elem2.value + "," + view.elem3.value + "," + view.elem4.value + "," + view.elem5.value + "," + view.elem6.value + "," + view.elem1.value;
			return str;
		}
	}
}